...
public class SingleTransactionModel {
    ...
    public SingleTransactionModel(int id, String transactionReference, double amountInEuro, String description, LocalDate value_date, TransactionType transactionType, String identificationCode, String ownerReferential) {
        this.id = id;
